...
public class ItemPartGroundDeviceSkid extends AItemPart{
	...
	public boolean isPartValidForPackDef(PackPart packPart){
		float width = packComponent.pack.skid.width;
	...
	public void addInformation(ItemStack stack, @Nullable World world, List<String> tooltipLines, ITooltipFlag flagIn){
		tooltipLines.add(I18n.format("info.item.ground_device.diameter") + packComponent.pack.skid.width);
		tooltipLines.add(I18n.format("info.item.ground_device.motivefriction") + 0);
		tooltipLines.add(I18n.format("info.item.ground_device.lateralfriction") + packComponent.pack.skid.lateralFriction);
