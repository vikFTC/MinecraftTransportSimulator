...
public class ItemPartGroundDeviceWheel extends AItemPart{
	...
	public boolean isPartValidForPackDef(PackPart packPart){
		float diameter = packComponent.pack.wheel.diameter;
	...
	public void addInformation(ItemStack stack, @Nullable World world, List<String> tooltipLines, ITooltipFlag flagIn){
		tooltipLines.add(I18n.format("info.item.ground_device.diameter") + packComponent.pack.wheel.diameter);
		tooltipLines.add(I18n.format("info.item.ground_device.motivefriction") + packComponent.pack.wheel.motiveFriction);
		tooltipLines.add(I18n.format("info.item.ground_device.lateralfriction") + packComponent.pack.wheel.lateralFriction);
