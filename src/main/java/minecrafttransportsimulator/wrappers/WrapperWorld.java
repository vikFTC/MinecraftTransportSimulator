...
public class WrapperWorld{
	...
	/**
	 *  Returns an instance of {@link WrapperEntity} for the entity of the passed-in ID.
	 */
	...
	/**
	 *  Returns an instance of {@link WrapperPlayer} for the player of the passed-in ID.
